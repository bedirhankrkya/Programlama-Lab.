...
#belirlediğimiz sayılar arasında n kadar sayı üretip bir listeye atıyoruz.
...
#hash tablomuzu daha rahat kontrol etmek için sıraladık.
print(sorted(my_list))

#---------------dict ile hash tablosu oluşturan fonk.---------------------
...
#----------------Liste yapısıyla hash tablosu oluşturma.-------------------
...
#-----------------Histogram bilgisi Dict ise mod bulma-------------------
frequency_max=-1 #mode degeri, döngüde karşılaştırılacak hafıza amaçlı deger.
mode=-1
...
def my_mode_wirh_dict(my_hist_d):
    frequency_max=-1 
    mode=-1
    for key in my_hist_d.keys():
        #print(key,my_hist_d[key])
